...
export function LandingPage() {
  ...
  // Global drag safety (mouse up & move)
  useEffect(() => {
  ...
  const handleTouchMove = (e: React.TouchEvent) => {
    if (!isDown.current || !sliderRef.current || e.touches.length === 0) return;
