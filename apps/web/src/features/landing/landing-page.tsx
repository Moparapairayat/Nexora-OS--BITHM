...
export function LandingPage() {
  return (
    <main className="relative min-h-dvh overflow-hidden">
      <HeroScene />
      <BrandedBackground variant="hero" className="z-[1]" />
      <div className="absolute right-5 top-8 z-20">
        <ThemeToggle />
      </div>
      <div className="relative z-10 mx-auto flex min-h-dvh w-full max-w-6xl items-center px-4 py-6 sm:px-8 md:py-8">
