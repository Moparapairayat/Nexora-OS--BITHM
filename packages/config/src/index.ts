  ...
  sourceRanking: [
    {
      ...
      matchedPhrases: [
        "requirements and constraints are analyzed for web/mobile usage",
        "responsive design and performance checks",
      ],
      originalExcerpt:
        "Responsive web design provides an optimal viewing and interaction experience across a wide range of devices (from desktop computer monitors to mobile phones). Testing should validate fluid grids, flexible images, and media queries across diverse viewports.",
      recommendation:
        "Partial reference detected. Add a formal Harvard citation: 'Marcotte, E. (2010) Responsive Web Design, A List Apart.' and include access date.",
    },
    {
      id: "src-ieee-829",
      ...
      citationStatus: "ok",
      matchedPhrases: [
        "testing should include navigation, form validation",
        "visible tests passed while hidden tests failed",
      ],
      originalExcerpt:
        "Standard test documentation prescribes systematic recording of navigation workflows, boundary input validation, edge cases (such as empty inputs and negative values), and formal evidence logs for assessment criteria.",
      recommendation:
        "Source is properly acknowledged under IEEE standards. Confirm in-text citation key (IEEE Std 829, 2018) is placed near test summary.",
    },
    {
      id: "src-wiki-rwd",
      ...
      matchedPhrases: [
        "analyzed for web/mobile usage and responsive behavior",
        "navigation, form validation, responsive design",
      ],
      originalExcerpt:
        "Responsive web design (RWD) or responsive design is an approach to web design that aims to make web pages render well on a variety of devices and window or screen sizes from minimum to maximum display size to ensure usability and satisfaction.",
      recommendation:
        "Missing citation for technical definition. Rephrase in your own analytical words or add academic citation to avoid uncredited overlap.",
    },
    {
      id: "src-pressman-se",
      ...
      citationStatus: "ok",
      matchedPhrases: [
        "requirements, design, testing evidence and implementation decisions",
      ],
      originalExcerpt:
        "Software engineering encompasses the systematic application of engineering approaches to the development of software. Testing evidence must substantiate requirements traceability and architectural decisions.",
      recommendation:
        "Standard textbook reference is valid. Verify corresponding Harvard bibliography entry in references list: 'Pressman, R.S. and Maxim, B.R. (2020) Software Engineering: A Practitioner's Approach. 9th edn. New York: McGraw-Hill Education.'",
    },
    {
      id: "src-bithm-vault",
      title: "BITHM Institutional Repository • Web & Mobile Unit Submission #2025-084",
      kind: "internal-submission",
      url: "vault://bithm/cs/2025/submission-084",
      author: "BITHM Student Peer Archive (2025)",
      similarity: 0.11,
      fuzzyScore: 0.16,
      semanticScore: 0.21,
      paraphraseScore: 16,
      internalOverlap: 0.11,
      rank: 5,
      citationStatus: "partial",
      matchedPhrases: [
        "correction plan and evidence coverage for the OTHM assessment criteria",
      ],
      originalExcerpt:
        "The submission report details the correction plan and evidence coverage for the OTHM qualification criteria across unit learning outcomes and scenario deliverables.",
      recommendation:
        "Internal institutional overlap detected. Ensure testing evidence reflections represent your own original code execution rather than shared lab templates.",
    },
  ],
  highlightedMatches: [
    {
      ...
      excerpt:
        "This report evaluates the requirements, design, testing evidence and implementation decisions for a web and mobile application project.",
      matchedSourceId: "src-pressman-se",
      originalPassage:
        "Software engineering encompasses the systematic application of engineering approaches to the development of software. Testing evidence must substantiate requirements traceability and architectural decisions.",
      severity: "LOW",
      reason: "Methodology phrasing overlap with Pressman & Maxim (2020) Software Engineering framework.",
    },
    {
      id: "match-p2",
      paragraph: 2,
      ...
      matchedSourceId: "src-rwd-marcotte",
      originalPassage:
        "Responsive web design provides an optimal viewing and interaction experience across a wide range of devices (from desktop computer monitors to mobile phones). Testing should validate fluid grids, flexible images, and media queries across diverse viewports.",
      severity: "MEDIUM",
      reason: "Substantive structural similarity (28%) with Ethan Marcotte's foundational Responsive Web Design specification.",
    },
    {
      id: "match-p3",
      paragraph: 3,
      ...
      matchedSourceId: "src-ieee-829",
      originalPassage:
        "Standard test documentation prescribes systematic recording of navigation workflows, boundary input validation, edge cases (such as empty inputs and negative values), and formal evidence logs for assessment criteria.",
      severity: "LOW",
      reason: "Test evidence phrasing matches standard IEEE 829 test documentation protocols.",
    },
  ],
  writingRisk: {
    ...
    features: [
      {
        label: "Sentence Rhythm Variance (CV)",
        value: "Natural human variation (CV: 0.44). Varied sentence lengths across paragraphs.",
        impact: "LOW",
      },
      {
        label: "N-gram Transition Perplexity",
        value: "High lexical entropy. Natural stylistic vocabulary distribution with authentic academic terms.",
        impact: "LOW",
      },
      {
        label: "Academic Domain Safeguard",
        value: "Protected valid scientific and engineering phrases ('empirical validation', 'boundary condition').",
        impact: "LOW",
      },
    ],
    sentences: [
      {
        index: 1,
        text: "This report evaluates the requirements, design, testing evidence and implementation decisions for a web and mobile application project.",
        wordCount: 19,
        aiProbability: 8,
        riskLevel: "LOW",
        reason: "Natural sentence structure with direct active academic intent.",
        flaggedFeatures: [],
      },
      {
        index: 2,
        text: "The application requirements and constraints are analyzed for web/mobile usage and responsive behavior.",
        wordCount: 14,
        aiProbability: 14,
        riskLevel: "LOW",
        reason: "Standard technical phrasing with domain-specific terminology.",
        flaggedFeatures: [],
      },
      {
        index: 3,
        text: "Testing should include navigation, form validation, responsive design and performance checks.",
        wordCount: 11,
        aiProbability: 10,
        riskLevel: "LOW",
        reason: "Concise domain-specific itemization.",
        flaggedFeatures: [],
      },
      {
        index: 4,
        text: "Visible tests passed while hidden tests failed for empty input and negative age values.",
        wordCount: 15,
        aiProbability: 6,
        riskLevel: "LOW",
        reason: "Specific empirical test outcomes with low generative predictability.",
        flaggedFeatures: [],
      },
      {
        index: 5,
        text: "The final report explains the correction plan and evidence coverage for the OTHM assessment criteria.",
        wordCount: 16,
        aiProbability: 9,
        riskLevel: "LOW",
        reason: "Institutional qualification nomenclature with natural syntax.",
        flaggedFeatures: [],
      },
    ],
